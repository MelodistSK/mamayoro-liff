...
export default async function handler(req, res) {
    ...
    try {
        ...
        const JOBSEEKER_API_TOKEN = process.env.KINTONE_JOBSEEKER_API_TOKEN;
        const APPOINTMENT_API_TOKEN = process.env.KINTONE_APPOINTMENT_API_TOKEN;
        ...
        const appointmentRecord = {
            ...
            LINEuserID: { value: userId },
            求職者ID: { value: jobseekerId }
        };
